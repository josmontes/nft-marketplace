...
export interface NftMarketContract {
   ...
   * Type: function
   */
  listedTokensCount(overrides?: ContractCallOverrides): Promise<BigNumber>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
   ...
   * Type: function
   */
  getOwnedTokens(overrides?: ContractCallOverrides): Promise<TokenResponse[]>;
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
